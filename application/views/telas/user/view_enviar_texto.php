<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-primary">
			...
			<!-- form start -->
			<?php
			echo form_open ('u/usuario/upload_texto');
			?>
				<div class="box-body">
					...
					<div class="form-group">
						...
						<p class="help-block">Respeite os <b><a href="<?php echo base_url ('u/termos') ?>">termos</a></b> da comunidade ao envio de arquivos ou publicação de
							textos, o envio de
