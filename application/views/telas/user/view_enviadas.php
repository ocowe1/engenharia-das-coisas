				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							...
							<li class="active"><a href="<?php echo base_url ('u/usuario/enviadas'); ?>"><i class="fa fa-envelope-o"></i> Enviados</a></li>
						</ul>
					</div>
					<!-- /.box-body -->
				</div>
							...
							<table class="table table-hover table-striped">
								...
								if(empty($emails)){
									...
									foreach($emails as $m){ ?>
										...
										<tr>
											<td><form action="<?php echo base_url ('u/a/enviado/'.$m->email_id); ?>"><button type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash-o"></i></button></form></td>
											<!--td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td-->
											<td class="mailbox-name"><a href="<?php echo base_url('u/m/enviado/' . $m->email_id)?>"><?php echo $m->user_name_enviado; ?></a></td>
