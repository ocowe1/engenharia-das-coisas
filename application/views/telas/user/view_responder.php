...
<div class="content-wrapper">
	...
	<section class="content-header">
		<ol class="breadcrumb">
			<li><a><i class="fa fa-dashboard"></i> <a href="<?php echo base_url ( 'usuario' ); ?>">Home </a> / <a
						href="<?php echo base_url ( 'u/usuario/mensagens' ); ?>">Mensagens</a> / <a href="<?php echo base_url ('usuario/ler/'.$e->email_id)?>">Ler</a> /Responder</a></li>
		</ol>
	</section>
	<br>
	<!-- Main content -->
	<section class="content">
		...
		<?php echo form_open ( 'u/usuario/resposta'); ?>
