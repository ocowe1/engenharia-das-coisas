<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-primary">
			...
			<!-- /.box-header -->
			<!-- form start -->
			<form role="form" enctype="multipart/form-data" action="<?php echo base_url ('g/e/upload'); ?>" method="post">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<p class="help-block">Respeite os <b><a
									href="<?php echo base_url ( 'g/termos' ) ?>">termos</a></b> da comunidade ao envio de
