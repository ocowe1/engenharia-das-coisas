...
//$id = $session['user_id'];
//$result = $this->model_user->recebidos($id);
...
<div class="content-wrapper">
	...
	<br><br>
		<section class="content">
			...
			<div class="row">
				<div class="col-md-3">
					<td><form action="<?php echo base_url ('gestor/escrever') ?>" method="post"><button type="submit" class="btn btn-primary btn-block margin-bottom">Escrever</button></form></td>
					...
					<div class="box box-solid">
						...
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								<li class="active"><a href="<?php echo base_url ('g/mensagens') ?>"><i class="fa fa-inbox"></i> Inbox

										<span class="label label-primary pull-right"><!-- fazer a contagem das mensagens que precisam ser lidas --></span></a></li>
								<li><a href="<?php echo base_url ('g/enviadas'); ?>"><i class="fa fa-envelope-o"></i> Enviados</a></li>
							</ul>
						</div>
						<!-- /.box-body -->
					</div>
						...
						<div class="box-body no-padding">
							...
							<div class="table-responsive mailbox-messages">
								<table class="table table-hover table-striped">
									...
									<tr>
										<td><form action="<?php echo base_url ('g/a/recebido/'.$m->email_id); ?>"><button type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash-o"></i></button></form></td>
										<!--td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td-->
										<td class="mailbox-name"><a href="<?php echo base_url('g/m/recebido/' . $m->email_id) ?>"><?php echo $m->user_name_enviado; ?></a><span class="username">
												<?php
												$this->load->model('model_gestor');
												$user_e = $this->model_gestor->busca($m->user_id_enviado);
