	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row">
				<div class="col-md-3">
					<td><form action="<?php echo base_url ('gestor/escrever') ?>"><button type="submit" class="btn btn-primary btn-block margin-bottom">Escrever</button></form></td>
				...
				<div class="col-md-9">
					<div class="box box-primary">
						...
						<div class="box-footer">
							...
							<td><form action="<?php echo  base_url ('g/a/enviado/'.$e->email_id); ?>"><button type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash-o"></i> Deletar</button></form></td>
						</div>
						<!-- /.box-footer -->
					</div>
