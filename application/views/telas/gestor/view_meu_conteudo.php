<div class="content-wrapper">
	...
	<section class="content">
		<?php $this->load->view ( 'telas/gestor/view_flashdata_p' ); ?>
		<div class="col-md-3">
			<div class="box box-solid">
				...
				if ( empty( $disciplinas ) ) {
					...
					foreach ($disciplinas as $d) {
						...
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								<li><a href="<?php echo base_url ( 'g/disciplina/' . $d->disciplina_id ) ?>">
...
<section id="nova" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content rounded-0">
			<form action="<?php echo base_url ( 'g/n/disciplina' ) ?>" method="post">
...
<section id="novo" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content rounded-0">
			<form role="form" enctype="multipart/form-data" action="<?php echo base_url ( 'g/n/conteudo/' . $d_id ) ?>"
				  method="post">
				<div class="modal-header border-0 rounded-0">
