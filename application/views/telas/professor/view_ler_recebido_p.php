	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row">
				<div class="col-md-3">
					<td><form action="<?php echo base_url ('p/m/escrever') ?>"><button type="submit" class="btn btn-primary btn-block margin-bottom">Escrever</button></form></td>
				...
				<div class="col-md-9">
					<div class="box box-primary">
						...
						<div class="box-header with-border">
							<form action="<?php echo base_url ('p/reportar/'.$e->email_id) ?>"><ul class="pull-right" ><button type="submit" class="btn btn-sm btn-light">Reportar</button></ul></form>
						...
						<div class="box-footer">
							<div class="pull-right">
									...
									<td><form action="<?php echo  base_url ('p/responder/'.$e->email_id); ?>"><button type="submit" class="btn btn-sm btn-default"><i class="fa fa-reply"></i> Responder</button></form></td>

							</div>
							<td><form action="<?php echo  base_url ('p/a/recebido/'.$e->email_id); ?>"><button type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash-o"></i> Deletar</button></form></td>
						</div>
						<!-- /.box-footer -->
					</div>
