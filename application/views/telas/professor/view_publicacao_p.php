			...
			<div class="col-md-12">
				...
				<div class="box box-widget">
													...
													<div class="modal-content rounded-0">
														...
														<div class="modal-body pt-0">
															...
															<div class="col mt-2 mt-sm-4">
																<form
																	action="<?php echo base_url ( 'p/bloquear/' . $q->publicacao_id ) ?>"
																	method="post">
												...
												<div class="modal-dialog">
													<div class="modal-content rounded-0">
														...
														<div class="modal-body pt-0">
															...
															<div class="col mt-2 mt-sm-4">
																<form
																	action="<?php echo base_url ( 'p/excluir/' . $q->publicacao_id ) ?>"
																	method="post">
																	<button id="confirm-btn" type="submit"
																			class="btn btn-block btn-primary rounded-0">
																		Confirmar
												...
												<div class="modal-dialog">
													<div class="modal-content rounded-0">
														...
														<div class="modal-body pt-0">
															...
															<div class="col mt-2 mt-sm-4">
																<form
																	action="<?php echo base_url ( 'p/ocultar/' . $q->publicacao_id ) ?>"
																	method="post">
																	<button id="confirm-btn" type="submit"
																			class="btn btn-block btn-primary rounded-0">
																		Confirmar
					...
					<div class="box-body">
						...
						<a href="<?php echo base_url ( 'professor/p/' . $q->publicacao_id . '/' . $q->titulo ); ?>"><span
							...
							<div class="box-comment">
								...
								<span class="username">
									...
									if ( $q->status === 'ativo' ) {
										?>
										<form
											action="<?php echo base_url ( 'professor/p/' . $q->publicacao_id . '/' . $c->comentario_id . '/r/comentario' ); ?>"
											method="post">
