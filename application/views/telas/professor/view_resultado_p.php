				...
				<div class="box box-widget">
					<div class="box-header with-border">
						<div class="user-block">
							...
							<form action="<?php echo base_url ('p/reportar/'.$q->publicacao_id) ?>"><ul class="pull-right" ><button type="submit" class="btn btn-sm btn-light">Reportar</button></ul></form>
					...
					<div class="box-body">
						...
						<table>
							<tr>
								<td>
									<form action="<?php echo base_url ( 'p/usuario/download/'.$q->publicacao_id ) ?>">
										<?php if ( $q->tipo == '1' ) { ?>
								...
								<td>
									<form
										action="<?php echo base_url ( 'p/usuario/p/' . $q->publicacao_id . '/curtir' ); ?>">
										<button type="submit"
											<?php
						...
						<a href="<?php echo base_url ( 'p/' . $q->publicacao_id ); ?>"><span
								class="pull-right text-muted"><?php echo $like . ' ' . $qtd_likes . ' | ' . $coment . ' Comentários'; ?></span></a>
					</div>
					<!-- /.box-body -->
					<div class="box-footer box-comments">
						<a href="<?php echo base_url ( 'p/' . $q->publicacao_id); ?>">
							<?php
					...
					<div class="box-footer">
						<form action="<?php echo base_url ( 'p/usuario/p/' . $q->publicacao_id . '/comentar' ); ?>"
							  method="post">
