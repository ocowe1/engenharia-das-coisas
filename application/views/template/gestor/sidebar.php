...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="<?php echo base_url ('g/feed') ?>">
                    <i class="fa fa-bars"></i> <span>Início</span>
                </a>
            </li>

            <li class="treeview">
                <a href="<?php echo base_url ('g/calendario') ?>">
			...
			<li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
				...
				<ul class="treeview-menu">
					<li><a href="<?php echo base_url('g/e/arquivo'); ?>"><i class="fa fa-circle-o"></i>Com arquivo</a></li>
					<li><a href="<?php echo base_url ('g/e/texto') ?>"><i class="fa fa-circle-o"></i>Texto</a></li>
				</ul>
			</li>

            <li class="treeview">
                <a href="<?php echo base_url ('g/mensagens') ?>">
			...
			<li class="treeview">
				<a href="<?php echo base_url ('g/membros') ?>">
					<i class="fa fa-users"></i> <span>Membros</span>
				</a>
			</li>

			<li class="treeview">
				<a href="<?php echo base_url ('g/contato')?>">
					<i class="fa fa-life-ring"></i> <span>Contato</span>
				</a>
			</li>

            <li class="treeview">
                <a href="<?php echo base_url ('g/info')?>">
