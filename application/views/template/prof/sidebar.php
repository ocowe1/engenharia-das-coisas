    ...
    <section class="sidebar">
        ...
        <div class="user-panel" style="padding-left: 4px;">
            ...
            <div class="pull-left info" style="padding-left: 5px;">
				...
				<a class="description">Professor</a>
            </div><br><br>
        </div>
        <!-- search form -->
        <form action="<?php echo base_url ('pesquisar') ?>" method="post" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="<?php echo base_url ('p/feed') ?>">
                    <i class="fa fa-bars"></i> <span>Início</span>
                </a>
            </li>

            <li class="treeview">
                <a href="<?php echo base_url ('p/m/conteudo') ?>">
                    <i class="fa fa-book"></i> <span>Meu conteúdo</span>
                </a>
            </li>

            <li class="treeview">
                <a href="<?php echo base_url ('p/calendario') ?>">
			...
			<li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
				...
				<ul class="treeview-menu">
					<li><a href="<?php echo base_url('p/e/arquivo'); ?>"><i class="fa fa-circle-o"></i>Com arquivo</a></li>
					<li><a href="<?php echo base_url ('p/e/texto') ?>"><i class="fa fa-circle-o"></i>Texto</a></li>
				</ul>
			</li>

            <li class="treeview">
                <a href="<?php echo base_url ('p/mensagens') ?>">
			...
			<li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
				...
				<ul class="treeview-menu">
					<li><a href="http://waewebsantos.esamc.br/waeweb/servlet/hwplgn?21" target="_blank"><i class="fa fa-circle-o"></i> Professor Net</a></li>
			...
			<li class="treeview">
				<a href="<?php echo base_url ('p/membros') ?>">
					<i class="fa fa-users"></i> <span>Membros</span>
				</a>
			</li>

			<li class="treeview">
				<a href="<?php echo base_url ('p/contato')?>">
					<i class="fa fa-life-ring"></i> <span>Contato</span>
				</a>
			</li>

            <li class="treeview">
                <a href="<?php echo base_url ('p/info')?>">
