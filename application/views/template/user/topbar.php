...
<header class="main-header">
	...
	<!-- Logo -->
	<a href="<?php echo base_url('u/feed') ?>" class="logo">
		...
		<ul class="nav navbar-nav"><li class="dropdown user user-menu">
				...
				<ul class="dropdown-menu">
					...
					<li class="user-footer">
						<div class="pull-left">
							<form action="<?php echo base_url ('u/perfil'); ?>">
								<input value="Perfil" type="submit" class="btn btn-default btn-flat">
							</form>
							<!--<a href="<?php// echo base_url ('u/perfil'); ?>" class="btn btn-default btn-flat">Perfil</a>-->
						</div>
						<div class="pull-right">
							<form action="<?php echo base_url ('logout'); ?>">
								<input value="Sair" type="submit" class="btn btn-default btn-flat">
							</form>
							<!--<a href="<?php// echo base_url ('u/logout'); ?>" class="btn btn-default btn-flat">Sair</a>-->
